...
class GridMDP(MDP):
    ...
    def __init__(self, grid, terminals, init=(0, 0), d_rand = 0.80, gamma=.9):
        ...
        for s in states:
            transitions[s] = {}
            for a in actlist:
                transitions[s][a] = self.calculate_T(s, a, d_rand)
    ...
    def to_arrows(self, policy):
        chars = {(1, 0): '>', (0, 1): '^', (-1, 0): '<', (0, -1): 'v', None: 'o'}
...
def value_iteration(mdp, epsilon=0.001):
    ...
    while True:
        ...
        if delta <= epsilon * (1 - gamma) / gamma:
            ...
            return U, convergence_time, iters
        iters += 1
...
def policy_iteration(mdp):
    ...
    while True:
        ...
        if unchanged:
            t2 = time.time()
            convergence_time = t2 - t1
            return pi, convergence_time, iters
